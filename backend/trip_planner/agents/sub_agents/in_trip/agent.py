...
from trip_planner.agents.sub_agents.in_trip.prompt import INTRIP_INSTR, TRIP_MONITOR_INSTR
from trip_planner.agents.sub_agents.in_trip.tools import (
...
trip_monitor_agent = Agent(
    ...
    instruction=TRIP_MONITOR_INSTR,
